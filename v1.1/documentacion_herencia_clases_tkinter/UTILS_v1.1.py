...
#basado en herencias de clases de tkinter que comente en el README hace unos meses
...
class gui_tkinter_widgets():
    ...
    def __init__(self, master, tipo_widget_param = None, self_clase_gui_donde_call_rutina = None, **kwargs_config_parametros):
        ...
        self.nombre_kwargs_dicc_imagen_boton = "dicc_imagen_boton"
        self.nombre_kwargs_dicc_imagen_boton_png_imagen = "png_imagen"
        self.nombre_kwargs_dicc_imagen_boton_tupla_imagen_resize = "tupla_imagen_resize"
    ...
    def config_atributos(self, **kwargs_config_parametros):
        ...
        if len(self.kwargs_config_parametros_lower_no_blank) != 0:
            ...
            #dicc_imagen_boton
            if self.nombre_kwargs_dicc_imagen_boton in lista_config_atributos_propios:

                if isinstance(self.kwargs_config_parametros_lower_no_blank[self.nombre_kwargs_dicc_imagen_boton], dict):
                    
                    png_imagen = self.kwargs_config_parametros_lower_no_blank[self.nombre_kwargs_dicc_imagen_boton].get(self.nombre_kwargs_dicc_imagen_boton_png_imagen, None)
                    tupla_imagen_resize = self.kwargs_config_parametros_lower_no_blank[self.nombre_kwargs_dicc_imagen_boton].get(self.nombre_kwargs_dicc_imagen_boton_tupla_imagen_resize, self.imagen_en_boton_tupla_resize_por_defecto)
...
class treeview_propio(gui_tkinter_widgets):
    ...
    def __init__(self, master, self_clase_gui_donde_call_rutina = None, **kwargs_config_widget):
        ...
        #(esto es por si se desea cambiar en el futuro el nombre el mismo sin tener que modificar el codigo de la clase)
        self.nombre_kwargs = "dicc_treeview"
                ...
                try:
                    ...
                    if existe_columna_en_df == "si":
                        ...
                        if isinstance(lista_dicc_tag_linea_completa, list):
                            ...
                            if self.nombre_kwargs_lista_dicc_tag_linea_completa_columna_df_tag_aplicar is not None:
                        ...
                        if isinstance(lista_dicc_tag_caracteres_cambiantes_comparativa, list):
                            ...
                            if self.nombre_kwargs_lista_dicc_tag_caracteres_cambiantes_comparativa_columna_df_filtro_registros_aplicar_tag is not None:
                            ...
                            if self.nombre_kwargs_lista_dicc_tag_caracteres_cambiantes_comparativa_columna_df_comparar_1 is not None:
                            ...
                            if self.nombre_kwargs_lista_dicc_tag_caracteres_cambiantes_comparativa_columna_df_comparar_2 is not None:
...
class entry_propio(gui_tkinter_widgets):
    ...
    def __init__(self, master, **kwargs_config_widget):
        ...
        self.nombre_kwargs_calendario_tupla_coord_place_y_width = "calendario_tupla_coord_place_y_width"
        self.nombre_kwargs_calendario_iconbitmap = "calendario_iconbitmap"

        self.lista_atributos_entry_dicc = [self.nombre_kwargs_formato_validacion, self.nombre_kwargs_texto_longitud_maxima
                                           , self.nombre_kwargs_titulo_messagebox_warning, self.nombre_kwargs_calendario_tupla_coord_place_y_width
                                           , self.nombre_kwargs_calendario_iconbitmap]
        ...
        self.calendario_tupla_coord_place_y_width = self.kwargs_config_widget[self.nombre_kwargs].get(self.nombre_kwargs_calendario_tupla_coord_place_y_width, None)
        self.calendario_iconbitmap = self.kwargs_config_widget[self.nombre_kwargs].get(self.nombre_kwargs_calendario_iconbitmap, None)
    ...
    def __varios_clase_hija(self, opcion_varios: Literal["crear_widget_objeto"
        ...
        if opcion_varios == "crear_widget_objeto":
            ...
            self.toplevel_calendario.transient()#impide que teniendo el calendario abierto y al clicar en otra ventana el toplevel paso por debajo de la ventana
