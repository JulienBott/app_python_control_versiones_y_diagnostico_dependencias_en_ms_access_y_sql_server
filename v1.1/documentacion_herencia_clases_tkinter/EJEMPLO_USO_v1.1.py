...
#importasr el modulo (OBLIGATORIO)
...
class clase_ventana_inicio:
    ...
    def __init__(self, master):
        ...
        self.kwargs_config_boton_2 =  {"width": 40
                                                , "dicc_imagen_boton": {"png_imagen": png_para_boton, "tupla_imagen_resize": (23, 23)}
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 5 - entry (con gui_tkinter_widgets)
##########################################################################################################
##########################################################################################################
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 6 - entry (con entry_propio) con reglas validacion
##########################################################################################################
##########################################################################################################
...
class clase_ventana_inicio:
    ...
    def __init__(self, master):
        ...
        self.kwargs_config_entry_1 = {"width": 15
                                , "bd": 2
                                , "relief": "solid"
                                , "dicc_colocacion": {"metodo": "place", "coord_x": 10, "coord_y": 10}
                                , "entry_dicc":
        ...
        self.kwargs_config_entry_2 = {"width": 15
                                    , "bd": 2
                                    , "relief": "solid"
        ...
        self.entry_1 = mod_utils.entry_propio(self.frame.widget_objeto, **self.kwargs_config_entry_1)
        self.entry_2 = mod_utils.gui_tkinter_widgets(self.frame.widget_objeto, tipo_widget_param = "entry", **self.kwargs_config_entry_2)

        self.strvar_entry = self.entry_1.variable_enlace
...
kwargs_config_entry_1 = {"width": 15
                        , "bd": 2
                        , "relief": "solid"
                        , "dicc_colocacion": {"metodo": "place", "coord_x": 10, "coord_y": 10}
                        , "entry_dicc":
...
kwargs_config_entry_2 = {"width": 15
                        , "bd": 2
                        , "relief": "solid"
                        , "dicc_colocacion": {"metodo": "place", "coord_x": 150, "coord_y": 10}
                        }
...
entry_1 = mod_utils.entry_propio(frame.widget_objeto, **kwargs_config_entry_1)
entry_2 = mod_utils.gui_tkinter_widgets(frame.widget_objeto, tipo_widget_param = "entry", **kwargs_config_entry_2)

strvar_entry = entry_1.variable_enlace
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 7 - entry fecha (con entry_propio) con calendario
##########################################################################################################
##########################################################################################################
...
class clase_de_mi_proyecto:
    ...
    def __init__(self, master):
        ...
        self.kwargs_config_boton_2 = {"text": "cambiar height"
                                        , "width": 15
                                        , "bg": "black"
                                        , "fg": "white"
                                        , "dicc_colocacion": {"metodo": "place", "coord_x": 270, "coord_y": 10}
                                        , "dicc_rutina":
                                                        {"rutina": "def_rutina_boton_2"}
                                    }
    ...
    def def_rutina_boton_1(self):
        ...
        self.treeview.actualizar_desde_df(df_datos)


    def def_rutina_boton_2(self):
        self.treeview.config_atributos(**{"height": 8})
...
kwargs_config_boton_2 = {"text": "cambiar height"
                        , "width": 15
                        , "bg": "black"
                        , "fg": "white"
                        , "dicc_colocacion": {"metodo": "place", "coord_x": 270, "coord_y": 10}
...
def def_rutina_boton_1():
    ...
    treeview.actualizar_desde_df(df_datos)


def def_rutina_boton_2():
    treeview.config_atributos(**{"height": 8})
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 11 - nuevo root tras pulsar un botón (toplevel)
##########################################################################################################
##########################################################################################################
...
class clase_de_mi_proyecto:
    ...
    def def_rutina_boton(self):
        ...
        self.otra_ventana = mod_utils.gui_tkinter_widgets(self.master.widget_objeto, tipo_widget_param = "toplevel", **kwargs_config_root_otra_ventana)
        self.otra_ventana.config_atributos(**kwargs_config_root_otra_ventana)
...
def def_rutina_boton():
    ...
    otra_ventana = mod_utils.gui_tkinter_widgets(None, tipo_widget_param = "toplevel", **kwargs_config_root_otra_ventana)
    otra_ventana.config_atributos(**kwargs_config_root_otra_ventana)
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 12 - Aplicar a un widget varias rutinas de evento bind (ejemplo combobox)
##########################################################################################################
##########################################################################################################
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 13 - Aplicar a una variable enlace (stringvar) varias rutinas de evento en modo trace (ejemplo combobox)
##########################################################################################################
##########################################################################################################
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 14 - scrolledtext desde un string
##########################################################################################################
##########################################################################################################
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 15 - scrolledtext desde un dataframe aplicando tags
##########################################################################################################
##########################################################################################################
...
##########################################################################################################
##########################################################################################################
# EJEMPLO 16 - Configuración de atributos nativos tkinter no integrados en mi_sistema_tkinter
