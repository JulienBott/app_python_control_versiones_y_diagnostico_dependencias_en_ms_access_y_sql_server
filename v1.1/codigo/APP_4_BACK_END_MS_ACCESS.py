    ...
    if opcion == "LISTA_RUTINAS":
        ...
        if len(lista_indices_rutinas_ini) != 0 and len(lista_indices_rutinas_ini) == len(lista_indices_rutinas_fin):
            ...
            for tipo_modulo_ini, nombre_modulo_ini, indice_ini, linea_codigo_ini in lista_indices_y_codigo_inicio_rutina:
                ...
                primer_parentesis_apertura = [lista_parentesis_apertura[ind].start() for ind, _ in enumerate(lista_parentesis_apertura)][0]

                lista_parentesis_cierre = list(re.finditer(r"\)", string_60_primeras_lineas))
                primer_parentesis_cierre = [lista_parentesis_cierre[ind].start() for ind, _ in enumerate(lista_parentesis_cierre)][0]
        ...
        if len(lista_modulos_con_variables_publicas) != 0:
            ...
            lista_variables_publicas_indices = [indice_linea for _, _, indice_linea, *_ in lista_variables_publicas]
        ...
        lista_modulos_con_variables_publicas_normales = [[tipo_modulo, nombre_modulo] for tipo_modulo, nombre_modulo, _, flag_variable_publica, _ in lista_calculos_variables_publicas
        ...
        for tipo_modulo_iteracion, nombre_modulo_iteracion in lista_modulos_con_variables_publicas_normales:
            ...
            lista_variables_publicas_lineas_modulo = [[flag_variable_publica, linea_codigo] 
                                                        for tipo_modulo, nombre_modulo, _, flag_variable_publica, linea_codigo in lista_calculos_variables_publicas
        ...
        lista_modulos_con_variables_publicas_definidas_usuario = [[tipo_modulo, nombre_modulo] for tipo_modulo, nombre_modulo, _, flag_variable_publica, _ in lista_calculos_variables_publicas
        ...
        for tipo_modulo_iteracion, nombre_modulo_iteracion in lista_modulos_con_variables_publicas_definidas_usuario:
            ...
            lista_variables_publicas_definidas_usuario_modulo = [flag_variable_publica
                                                                    for tipo_modulo, nombre_modulo, _, flag_variable_publica, _ in lista_calculos_variables_publicas
...
def func_access_bbdd_codigo_calculos_varios(opcion, **kwargs):
    ...
    if opcion == "QUITAR_ENCAPSULADO_ENTRE_COMILLAS_DOBLES":
        ...
        lista_indices_parentesis_apertura = [lista_indices_parentesis_apertura[ind].start() for ind, _ in enumerate(lista_indices_parentesis_apertura)]
        lista_indices_parentesis_cierre = [lista_indices_parentesis_cierre[ind].start() for ind, _ in enumerate(lista_indices_parentesis_cierre)]
        ...
        if len(lista_indices_parentesis_apertura) != 0 and len(lista_indices_parentesis_apertura) == len(lista_indices_parentesis_cierre):
            ...
            lista_indices_comas = [lista_indices_comas[ind].start() for ind, _ in enumerate(lista_indices_comas)]
...
def func_diagnostico_access_tablas_codigo_preservar(opcion, linea_codigo):
    ...
    lista_indices_localiz_comillas_dobles_temp_2 = [lista_indices_localiz_comillas_dobles_temp_1[ind].start() for ind, _ in enumerate(lista_indices_localiz_comillas_dobles_temp_1)]
...
def def_proceso_access_2_diagnostico(ruta_destino_excel_diagnostico_access):
    ...
    try:
        ...
        df_diagnostico_dependencias = (df_diagnostico_dependencias[lista_headers_df_dependencias].sort_values([i for i in lista_headers_df_dependencias]
                                                                                , ascending = [True for _ in lista_headers_df_dependencias]))
        ...
        df_diagnostico_sin_dependencias = (df_diagnostico_sin_dependencias[lista_headers_df_sin_dependencias].sort_values([i for i in lista_headers_df_sin_dependencias]
                                                                                , ascending = [True for _ in lista_headers_df_sin_dependencias]))
        ...
        df_diagnostico_tablas_check_manual = (df_diagnostico_tablas_check_manual[lista_headers_df_check_manual_tablas].sort_values([i for i in lista_headers_df_check_manual_tablas]
                                                                                , ascending = [True for _ in lista_headers_df_check_manual_tablas]))
        ...
        df_listado_objetos = df_listado_objetos[lista_headers_df_listado].sort_values(lista_headers_df_listado, ascending = [True for _ in lista_headers_df_listado])
        ...
        saveas = os.path.normpath(os.path.join(ruta_destino_excel_diagnostico_access, f"DEPENDENCIAS_MS_ACCESS_{now}.xlsb"))
