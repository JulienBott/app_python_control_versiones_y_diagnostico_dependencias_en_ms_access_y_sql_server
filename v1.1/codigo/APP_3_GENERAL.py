...
ico_app = os.path.join(sys._MEIPASS, "ico_app.ico") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "ico_app.ico")
pdf_guia_usuario = os.path.join(sys._MEIPASS, "GUIA_USUARIO_V1.1.pdf") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "GUIA_USUARIO_V1.1.pdf")

img_guia_usuario = os.path.join(sys._MEIPASS, "img_guia_usuario.png") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "img_guia_usuario.png")
img_boton_procesos = os.path.join(sys._MEIPASS, "img_boton_procesos.png") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "img_boton_procesos.png")
img_boton_add = os.path.join(sys._MEIPASS, "img_boton_add.png") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "img_boton_add.png")
img_boton_clear = os.path.join(sys._MEIPASS, "img_boton_clear.png") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "img_boton_clear.png")
img_boton_sql_server_authentication = os.path.join(sys._MEIPASS, "img_boton_sql_server_authentication.png") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "img_boton_sql_server_authentication.png")
img_seleccionar_all_none = os.path.join(sys._MEIPASS, "img_seleccionar_all_none.png") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "img_seleccionar_all_none.png")
img_boton_dependencias_sql_server = os.path.join(sys._MEIPASS, "img_boton_dependencias_sql_server.png") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "img_boton_dependencias_sql_server.png")
img_control_versiones_boton_ver = os.path.join(sys._MEIPASS, "img_control_versiones_boton_ver.png") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "img_control_versiones_boton_ver.png")
img_control_versiones_boton_excel = os.path.join(sys._MEIPASS, "img_control_versiones_boton_excel.png") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "img_control_versiones_boton_excel.png")
img_control_versiones_boton_migrar_lineas_codigo = os.path.join(sys._MEIPASS, "img_control_versiones_boton_migrar_lineas_codigo.png") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "img_control_versiones_boton_migrar_lineas_codigo.png")
img_control_versiones_boton_merge_bbdd_fisica = os.path.join(sys._MEIPASS, "img_control_versiones_boton_merge_bbdd_fisica.png") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "img_control_versiones_boton_merge_bbdd_fisica.png")

ruta_plantilla_control_versiones_xls = os.path.join(sys._MEIPASS, "PLANTILLA_CONTROL_VERSIONES.xlsb") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "PLANTILLA_CONTROL_VERSIONES.xlsb")
ruta_plantilla_diagnostico_access_xls = os.path.join(sys._MEIPASS, "PLANTILLA_DIAGNOSTICO_MS_ACCESS.xlsb") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "PLANTILLA_DIAGNOSTICO_MS_ACCESS.xlsb")
ruta_plantilla_diagnostico_sql_server_xls = os.path.join(sys._MEIPASS, "PLANTILLA_DIAGNOSTICO_SQL_SERVER.xlsb") if getattr(sys, 'frozen', False) else os.path.join(pathlib.Path(__file__).parent.absolute(), "PLANTILLA_DIAGNOSTICO_SQL_SERVER.xlsb")
...
nombre_app = "v1.1 - APP CONTROL VERSIONES EN MS ACCESS & SQL SERVER"
nombre_guia_usuario = "APP_CONTROL_VERSIONES_EN_MS_ACCESS_Y_SQL_SERVER_GUIA_USUARIO"
...
#listas que sirven para crear las opciones del combobox de "Acción" en la GUI de control versiones en el cuadro de MERGE
...
lista_headers_df_codigo_control_versiones_1 = ["NUM_LINEA", "CODIGO_CON_NUM_LINEA", "CODIGO_CON_NUM_LINEA_OTRA_BBDD", "CONTROL_CAMBIOS_ORIGINAL", "CONTROL_CAMBIOS_ACTUAL"]
lista_headers_df_codigo_control_versiones_2 = ["NUM_LINEA", "CODIGO", "CODIGO_OTRA_BBDD", "CODIGO_CON_NUM_LINEA", "CODIGO_CON_NUM_LINEA_OTRA_BBDD", "CONTROL_CAMBIOS_ORIGINAL", "CONTROL_CAMBIOS_ACTUAL"]
...
dicc_procesos = {"PROCESO_01":
                    ...
                    , "PROCESO_03":
                        ...
                        , "COMENTARIO": [
                                    ...
                                    , "IMPORTANTE:Se abrira una nueva ventana donde se listaran solo las bbdd donde tengas permiso de acceso a los códigos de objetos"
    ...
    if opcion == "PROCESOS_LOGS_ERRORES_IMPORT_BBDD":
        ...
        if isinstance(lista_dicc_errores_procesos, list):
            ...
            for dicc in lista_dicc_errores_procesos:
                ...
                saveas = os.path.normpath(os.path.join(ruta_destino_fichero_logs, nombre_fich_logs))
...
def func_dicc_control_versiones(**kwargs):
    ...
    #se configuran los df agregando columnas necesdarias para el calculo de control de versiones
    check_ya_existe = dicc_control_versiones_tipo_concepto["YA_EXISTE"]
    check_solo_bbdd_1 = dicc_control_versiones_tipo_concepto["SOLO_EN_BBDD_01"]
    check_solo_bbdd_2 = dicc_control_versiones_tipo_concepto["SOLO_EN_BBDD_02"]

    lista_columnas_df = (lista_headers_df_codigo_control_versiones_1 + [col for col in df_codigo_bbdd_1.columns if col not in lista_headers_df_codigo_control_versiones_1]
                        if check_objeto in [check_ya_existe, check_solo_bbdd_1]
                        else lista_headers_df_codigo_control_versiones_1 + [col for col in df_codigo_bbdd_2.columns if col not in lista_headers_df_codigo_control_versiones_1]
                        if check_objeto == check_solo_bbdd_2
                        else [])

    df_temp1 = pd.DataFrame(columns = lista_columnas_df)
    if isinstance(df_codigo_bbdd_1, pd.DataFrame):
        df_temp1 = df_codigo_bbdd_1.copy()
        df_temp1[lista_headers_df_codigo_control_versiones_1] = [None for _ in lista_headers_df_codigo_control_versiones_1]

    df_temp2 = pd.DataFrame(columns = lista_columnas_df)
    if isinstance(df_codigo_bbdd_2, pd.DataFrame):
        df_temp2 = df_codigo_bbdd_2.copy()
        df_temp2[lista_headers_df_codigo_control_versiones_1] = [None for _ in lista_headers_df_codigo_control_versiones_1]


    #se calcula la columna CODIGO_OTRA_BBDD (se usa en la GUI para localizar las diferencias de caracteres por linea con cambios)
    df_temp1 = (pd.merge(df_temp1[[col for col in df_temp1.columns]], df_temp2[["CODIGO"]], 
                how = "left", left_index = True, right_index = True, suffixes = ("", "_OTRA_BBDD")))
    
    df_temp2 = (pd.merge(df_temp2[[col for col in df_temp2.columns]], df_temp1[["CODIGO"]], 
                how = "left", left_index = True, right_index = True, suffixes = ("", "_OTRA_BBDD")))
    
    df_temp1 = df_temp1.replace({np.nan: None})
    df_temp2 = df_temp2.replace({np.nan: None})


    #se reordenan las columnas de los df
...
def def_control_versiones_export_excel(tipo_bbdd, lista_control_versiones_selecc, ruta_excel):
    ...
    now = dt.datetime.now()
    saveas = os.path.normpath(os.path.join(ruta_excel, "CONTROL_VERSIONES_" + tipo_bbdd + "_" + str(re.sub("[^0-9a-zA-Z]+", "_", str(now))) + ".xlsb"))
...
def def_merge_access_ajustes_manuales():
    ...
    if len(lista_librerias_dll_ajuste_manual) + len(lista_modulos_ajuste_manual) != 0:
        ...
        df_temp = pd.DataFrame({"CODIGO_CON_NUM_LINEA": lista_para_df})
        ...
        df_temp[["NUM_LINEA", "CODIGO", "CONTROL_CAMBIOS_ORIGINAL", "CONTROL_CAMBIOS_ACTUAL"]] = [None, None, None, None]
...
def def_merge_bbdd_fisicas(tipo_bbdd_selecc, lista_dicc_objetos_migrar_bbdd_fisica, ruta_export):
    ...
    if tipo_bbdd_selecc == "MS_ACCESS":
        ...
        if len(lista_modulos_con_cambios) != 0:
            ...
            for tipo_modulo_con_cambios, nombre_modulo_con_cambios in lista_modulos_con_cambios:
                ...
                if len(lista_rutinas_para_reconstruccion_modulo):
                    ...
                    for _, nombre_rutina, df_codigo_para_reconstrucciion_modulo, _, accion_a_realizar in lista_rutinas_para_reconstruccion_modulo:
        ...
        ruta_carpeta_documentacion = os.path.normpath(os.path.join(ruta_export, nombre_carpeta_documentacion))
        ...
        if len(lista_dicc_tablas_y_vinculos_con_cambios) != 0:
            ...
            ruta_carpeta_documentacion_tablas_y_vinculos = os.path.normpath(os.path.join(ruta_carpeta_documentacion, nombre_carpeta_documentacion_tablas_y_vinculos))
            ...
            for dicc_tablas_y_vinculos in lista_dicc_tablas_y_vinculos_con_cambios:
                ...
                ruta_fichero_tablas_y_vinculos = os.path.normpath(os.path.join(ruta_carpeta_documentacion_tablas_y_vinculos, nombre_fichero_tablas_y_vinculos))
        ...
        if len(lista_dicc_modulos_con_cambios) != 0:
            ...
            ruta_carpeta_documentacion_modulos = os.path.normpath(os.path.join(ruta_carpeta_documentacion, nombre_carpeta_documentacion_modulos))
            ...
            for dicc_modulos in lista_dicc_modulos_con_cambios:
                ...
                ruta_carpeta_documentacion_modulos_iteracion = os.path.normpath(os.path.join(ruta_carpeta_documentacion_modulos, nombre_carpeta_documentacion_modulos_iteracion))
                ...
                ruta_fichero_modulo_reconstruido_iteracion = os.path.normpath(os.path.join(ruta_carpeta_documentacion_modulos_iteracion, nombre_fichero_modulo_reconstruido_iteracion))
                ...
                for nombre_rutina_documentacion, df_codigo_rutina_documentacion in lista_rutinas_documentacion:
                    ...
                    ruta_fichero_rutina_iteracion = os.path.normpath(os.path.join(ruta_carpeta_documentacion_modulos_iteracion, nombre_fichero_rutina_iteracion))
        ...
        try:
            ...
            path_bbdd = os.path.normpath(path_bbdd)
    ...
    ####################################################################################################################################
        ...
        if len(lista_esquemas_con_cambios) != 0:
            for esquema in lista_esquemas_con_cambios:
                ...
                ruta_carpeta_documentacion_esquemas = os.path.normpath(os.path.join(ruta_carpeta_documentacion, esquema))
                ...
                for tipo_objeto_esquema in lista_tipo_objetos_iteracion_esquemas:
                    ...
                    ruta_carpeta_documentacion_esquemas_tipo_objetos = os.path.normpath(os.path.join(ruta_carpeta_documentacion_esquemas, tipo_objeto_esquema))
                    ...
                    for nombre_objeto_documentacion, df_codigo_documentacion in lista_descarga_objetos:
                        ...
                        ruta_fichero_txt = os.path.normpath(os.path.join(ruta_carpeta_documentacion_esquemas_tipo_objetos, nombre_fichero_txt))
