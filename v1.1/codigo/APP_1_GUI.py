    ...
    def __init__(self, master, kwargs_gui_tags_scrolledtext_scripts = None, **dicc_kwargs_gui):
        ...
        for frame_contenedor in self.kwargs_gui_widgets_clase_actual.keys():
            ...
            for frame_contenedor_widget, frame_contenedor_kwargs_widget in kwargs_gui_app_frame_iter_widgets.items():
                ...
                if tipo_widget in ["label", "combobox", "entry", "button", "listbox"]:
                ...
                elif tipo_widget == "scrolledtext_propio":
...
class gui_ventana_control_versiones():
    ...
    def __init__(self, master, kwargs_gui_ventana_inicio = None, kwargs_gui_tags_scrolledtext_scripts = None):
        ...
        self.kwargs_gui_widgets_clase_actual = self.kwargs_gui_ventana_inicio[self.clase_gui_nombre].get("frames_root")
        self.lista_columnas_df_para_treeview = self.kwargs_gui_widgets_clase_actual["frame_inicio"]["WIDGET_49"]["kwargs_config"]["treeview_dicc"]["columnas_df"]
        self.kwargs_gui_tags_scrolledtext_scripts = kwargs_gui_tags_scrolledtext_scripts
            ...
            if len(tipo_objeto_selecc) == 0:
                ...
                if len(tipo_concepto_selecc) == 0:
                    ...
                    if not isinstance(lista_control_versiones_segun_tipo_objeto_selecc, list):
                        ...
                        self.widget_objeto_treeview_objetos.actualizar_desde_df(df_treeview)
    ...
    def def_control_versiones_update_subform_objetos_click_item(self, event):
        ...
        global_tipo_objeto_subform = self.widget_objeto_treeview_objetos.datos_item_seleccionado["lista_datos_item_seleccionado"][1]
        global_repositorio_subform = self.widget_objeto_treeview_objetos.datos_item_seleccionado["lista_datos_item_seleccionado"][2]
        global_nombre_objeto_subform = self.widget_objeto_treeview_objetos.datos_item_seleccionado["lista_datos_item_seleccionado"][3]
...
class gui_ventana_merge_bbdd_fisicas():
    ...
    def __init__(self, master, kwargs_gui_ventana_inicio = None, kwargs_gui_tags_scrolledtext_scripts = None):
        ...
        self.kwargs_gui_widgets_clase_actual = kwargs_gui_ventana_inicio[self.clase_gui_nombre].get("frames_root")
        self.lista_columnas_df_para_treeview = self.kwargs_gui_widgets_clase_actual["frame_inicio"]["WIDGET_76"]["kwargs_config"]["treeview_dicc"]["columnas_df"]
        self.kwargs_gui_tags_scrolledtext_scripts = kwargs_gui_tags_scrolledtext_scripts
    ...
    def def_merge_bbdd_fisicas_update_subform_objetos_click_item(self, event, opcion_proceso_merge):
        ...
        tipo_bbdd_seek = self.widget_objeto_treeview_objetos.datos_item_seleccionado["lista_datos_item_seleccionado"][0]
        tipo_objeto_subform_seek = self.widget_objeto_treeview_objetos.datos_item_seleccionado["lista_datos_item_seleccionado"][1]
        tipo_repositorio_seek = self.widget_objeto_treeview_objetos.datos_item_seleccionado["lista_datos_item_seleccionado"][2]
        repositorio_seek = self.widget_objeto_treeview_objetos.datos_item_seleccionado["lista_datos_item_seleccionado"][3]
        nombre_objeto_seek = self.widget_objeto_treeview_objetos.datos_item_seleccionado["lista_datos_item_seleccionado"][4]
        estado_migracion = self.widget_objeto_treeview_objetos.datos_item_seleccionado["lista_datos_item_seleccionado"][5]
                                            ...
                                            , "frames_root":
                                                    {"frame_guia_usuario":
                                                                ...
                                                                , "WIDGET_01":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "width": 12
                                                                                                , "fg": "black"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 560, "coord_y": 10}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_02":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"width": 40
                                                                                                , "image": mod_gen.img_guia_usuario
                                                                                                , "compound": "left"
                                                                                                , "imagen_tupla_resize": (23, 23)
                                                                                                , "controltiptext": "Descarga la guia de usuario"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 670, "coord_y": 10}
                                                                                                , "dicc_rutina":
                                                    ...
                                                    , "frame_procesos":
                                                                {"frame":
                                                                        ...
                                                                        , "bd": 2
                                                                        , "relief": "solid"
                                                                        , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 50}
                                                                        }
                                                                ...
                                                                , "WIDGET_04":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "black"
                                                                                                , "anchor": "w"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 39}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_06":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"width": 40
                                                                                                , "image": mod_gen.img_boton_procesos
                                                                                                , "compound": "left"
                                                                                                , "imagen_tupla_resize": (33, 23)
                                                                                                , "controltiptext": "Ejecuta el proceso seleccionado"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 320, "coord_y": 38}
                                                                                                , "dicc_rutina":
                                                                ...
                                                                , "WIDGET_07":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "black"
                                                                                                , "wrap": tk.WORD
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 70}
                                                                                                , "justify": tk.LEFT
                                                                                                , "anchor": "w"
                                                                                                }
                                                                            }
                                                    ...
                                                    , "frame_ms_access":
                                                                    {"frame":
                                                                            ...
                                                                            , "bd": 2
                                                                            , "relief": "solid"
                                                                            , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 240}
                                                                            }
                                                                    ...
                                                                    , "WIDGET_10":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    {"font": ("Calibri", 10)
                                                                                                    , "width": 60
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 110, "coord_y": 40}
                                                                                                    , "justify": tk.LEFT
                                                                                                    , "state": tk.DISABLED
                                                                                                    }
                                                                                }
                                                                    ...
                                                                    , "WIDGET_11":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    {"width": 40
                                                                                                    , "image": mod_gen.img_boton_add
                                                                                                    , "compound": "left"
                                                                                                    , "imagen_tupla_resize": (33, 23)
                                                                                                    , "controltiptext": "Agrega la bbdd 1 de MS Access"
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 570, "coord_y": 38}
                                                                                                    , "dicc_rutina":
                                                                    ...
                                                                    , "WIDGET_12":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    {"width": 40
                                                                                                    , "image": mod_gen.img_boton_clear
                                                                                                    , "compound": "left"
                                                                                                    , "imagen_tupla_resize": (33, 23)
                                                                                                    , "controltiptext": "Limpia la bbdd 1 de MS Access"
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 630, "coord_y": 38}
                                                                                                    , "dicc_rutina":
                                                                                                                    {"rutina": "def_GUI_ms_access" #la rutina tiene que estar definida en la clase gui_ventana_inicio
                                                                                                                    , "tipo_rutina": "command"
                                                                    ...
                                                                    , "WIDGET_13":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    ...
                                                                                                    , "fg": "black"
                                                                                                    , "anchor": "w"
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 79}
                                                                                                    }
                                                                                }
                                                                    ...
                                                                    , "WIDGET_14":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    {"font": ("Calibri", 10)
                                                                                                    , "width": 60
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 110, "coord_y": 80}
                                                                                                    , "justify": tk.LEFT
                                                                                                    , "state": tk.DISABLED
                                                                                                    }
                                                                                }
                                                                    ...
                                                                    , "WIDGET_15":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    ...
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 570, "coord_y": 78}
                                                                                                    , "dicc_rutina":
                                                                                                                    {"rutina": "def_GUI_ms_access" #la rutina tiene que estar definida en la clase gui_ventana_inicio
                                                                                                                    , "tipo_rutina": "command"
                                                                    ...
                                                                    , "WIDGET_16":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    ...
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 630, "coord_y": 78}
                                                                                                    , "dicc_rutina":
                                                                                                                    {"rutina": "def_GUI_ms_access" #la rutina tiene que estar definida en la clase gui_ventana_inicio
                                                                                                                    , "tipo_rutina": "command"
                                                    ...
                                                    , "frame_sql_server":
                                                                    {"frame":
                                                                            ...
                                                                            , "bd": 2
                                                                            , "relief": "solid"
                                                                            , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 390}
                                                                            }
                                                                    ...
                                                                    , "WIDGET_20":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    ...
                                                                                                    , "fg": "black"
                                                                                                    , "anchor": "w"
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 320, "coord_y": 39}
                                                                                                    }
                                                                                }
                                                                    ...
                                                                    , "WIDGET_21":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    {"font": ("Calibri", 10)
                                                                                                    , "width": 25
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 390, "coord_y": 40}
                                                                                                    , "justify": tk.LEFT
                                                                                                    }
                                                                                }
                                                                    ...
                                                                    , "WIDGET_22":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    ...
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 620, "coord_y": 38}
                                                                                                    , "dicc_rutina":
                                                                                                                    {"rutina": "def_GUI_sql_server" #la rutina tiene que estar definida en la clase gui_ventana_inicio
                                                                                                                    , "tipo_rutina": "command"
                                                                    ...
                                                                    , "WIDGET_25":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    ...
                                                                                                    , "fg": "black"
                                                                                                    , "anchor": "w"
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 320, "coord_y": 79}
                                                                                                    }
                                                                                }
                                                                    ...
                                                                    , "WIDGET_26":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    {"font": ("Calibri", 10)
                                                                                                    , "width": 25
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 390, "coord_y": 80}
                                                                                                    , "justify": tk.LEFT
                                                                                                    }
                                                                                }
                                                                    ...
                                                                    , "WIDGET_27":
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    ...
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 620, "coord_y": 78}
                                                                                                    , "dicc_rutina":
                                                                                                                    {"rutina": "def_GUI_sql_server" #la rutina tiene que estar definida en la clase gui_ventana_inicio
                                                                                                                    , "tipo_rutina": "command"
                                                    ...
                                                    , "frame_resolucion_pantalla":
                                                                    {"frame":
                                                                            {"width": 700
                                                                            , "height": 30
                                                                            , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 530}
                                                                            }
                                                                    ...
                                                                    , "WIDGET_29": #el nombre de la key aqui es importante se hace referencia mas abajo despues de declarar este diccionario
                                                                                ...
                                                                                , "kwargs_config":
                                                                                                    ...
                                                                                                    , "width": 50
                                                                                                    , "fg": "red"
                                                                                                    , "colocacion_dicc": {"metodo": "place", "coord_x": 160, "coord_y": 0}
                                                                                                    , "anchor": "w"
                                                                                                    }
                                                                                }
                                                                    }
                                                    ...
                                                    {"frame_inicio":
                                                                ...
                                                                , "WIDGET_30":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "black"
                                                                                                , "anchor": "w"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 20}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_31":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"font": ("Calibri", 10)
                                                                                                , "width": 30
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 100, "coord_y": 20}
                                                                                                , "justify": tk.LEFT
                                                                                                , "state": tk.DISABLED
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_33":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"font": ("Calibri", 10)
                                                                                                , "width": 30
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 100, "coord_y": 50}
                                                                                                , "justify": tk.LEFT
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_34":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "black"
                                                                                                , "anchor": "w"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 80}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_35":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"font": ("Calibri", 10)
                                                                                                , "width": 30
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 100, "coord_y": 80}
                                                                                                , "justify": tk.LEFT
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_36":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"width": 40
                                                                                                , "image": mod_gen.img_boton_sql_server_authentication
                                                                                                , "compound": "left"
                                                                                                , "imagen_tupla_resize": (23, 23)
                                                                                                , "controltiptext": "Crea la connecting string a SQL Server y la guarda en memoria"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 340, "coord_y": 48}
                                                                                                , "dicc_rutina":
                                                    ...
                                                    {"frame_inicio":
                                                                ...
                                                                , "WIDGET_38":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"font": ("Calibri", 10)
                                                                                                , "width": 20
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 120, "coord_y": 20}
                                                                                                , "justify": tk.LEFT
                                                                ...
                                                                , "WIDGET_39":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "black"
                                                                                                , "anchor": "w"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 56}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_40":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"width": 40
                                                                                                , "image": mod_gen.img_seleccionar_all_none
                                                                                                , "compound": "left"
                                                                                                , "imagen_tupla_resize": (20, 20)
                                                                                                , "controltiptext": "Selecciona o des-selecciona todas las bases de datos SQL Server"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 235, "coord_y": 50}
                                                                                                , "dicc_rutina":
                                            ...
                                            , "frames_root":
                                                    {"frame_inicio":
                                                                ...
                                                                , "WIDGET_44":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"font": ("Calibri", 10)
                                                                                                , "width": 30
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 140, "coord_y": 20}
                                                                                                , "justify": tk.LEFT
                                                                                                ...
                                                                                                , "lista_dicc_rutina_trace_variable_enlace":
                                                                                                                [{"rutina": "def_control_versiones_cambio_tipo_objeto" #la rutina tiene que estar definida en la clase gui_ventana_control_versiones
                                                                                                                    , "tipo_trace": "write"}
                                                                                                                ]
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_46":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"font": ("Calibri", 10)
                                                                                                , "width": 30
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 140, "coord_y": 50}
                                                                                                , "justify": tk.LEFT
                                                                ...
                                                                , "WIDGET_47":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"width": 40
                                                                                                , "image": mod_gen.img_control_versiones_boton_ver
                                                                                                , "compound": "left"
                                                                                                , "imagen_tupla_resize": (33, 23)
                                                                                                , "controltiptext": "Actualiza el subformulario de objetos con variaciones entre las 2 bases de datos"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 400, "coord_y": 35}
                                                                                                , "dicc_rutina":
                                                                ...
                                                                , "WIDGET_48":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"width": 40
                                                                                                , "image": mod_gen.img_control_versiones_boton_excel
                                                                                                , "compound": "left"
                                                                                                , "imagen_tupla_resize": (33, 23)
                                                                                                , "controltiptext": "Exporta a excel los objetos con variaciones entre las 2 bases de datos"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 480, "coord_y": 35}
                                                                                                , "dicc_rutina":
                                                                                                                {"rutina": "def_control_versiones_frame_inicio_click_boton" #la rutina tiene que estar definida en la clase gui_ventana_control_versiones
                                                                                                                , "tipo_rutina": "command"
                                                                ...
                                                                , "WIDGET_49":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 100}
                                                                                                , "treeview_dicc": {"height": 5
                                                                ...
                                                                , "WIDGET_50":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "white"
                                                                                                , "justify": tk.CENTER
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 243}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_51":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "white"
                                                                                                , "anchor": "w"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 130, "coord_y": 243}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_52":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "bg": "#DDE1E2"
                                                                                                , "wrap": tk.NONE
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 270}
                                                                ...
                                                                , "WIDGET_53":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "white"
                                                                                                , "justify": tk.CENTER
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 850, "coord_y": 243}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_54":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "white"
                                                                                                , "anchor": "w"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 960, "coord_y": 243}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_55":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "bg": "#DDE1E2"
                                                                                                , "wrap": tk.NONE
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 850, "coord_y": 270}
                                                ...
                                                , "frame_merge":
                                                                {"frame":
                                                                        ...
                                                                        , "bd": 2
                                                                        , "relief": "solid"
                                                                        , "colocacion_dicc": {"metodo": "place", "coord_x": 850, "coord_y": 100}
                                                                        }
                                                                ...
                                                                , "WIDGET_57":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "black"
                                                                                                , "justify": tk.CENTER
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 265, "coord_y": 0}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_58":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "black"
                                                                                                , "justify": tk.CENTER
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 387, "coord_y": 0}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_59":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "black"
                                                                                                , "justify": tk.CENTER
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 500, "coord_y": 0}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_60":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "black"
                                                                                                , "justify": tk.CENTER
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 647, "coord_y": 0}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_62":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"font": ("Calibri", 10)
                                                                                                , "width": 10
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 80, "coord_y": 70}
                                                                                                , "justify": tk.LEFT
                                                                                                , "combobox_lista_opciones": mod_gen.lista_GUI_seleccion_bbdd
                                                                                                , "dicc_rutina":
                                                                                                                {"rutina": "def_proceso_merge_combobox_bbdd_selecc" #la rutina tiene que estar definida en la clase gui_ventana_control_versiones
                                                                                                                , "tipo_rutina": "event"
                                                                                                                , "tipo_bind": "<<ComboboxSelected>>" 
                                                                                                                # , "parametros_args": ("ACTUALIZAR_SUBFORM_OBJETOS_CONTROL_VERSIONES",)    
                                                                                                                }
                                                                ...
                                                                , "WIDGET_63":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "black"
                                                                                                , "anchor": "w"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 200, "coord_y": 70}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_64":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"font": ("Calibri", 10)
                                                                                                , "width": 15
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 270, "coord_y": 70}
                                                                                                , "justify": tk.LEFT
                                                                ...
                                                                , "WIDGET_65":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "black"
                                                                                                , "anchor": "w"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 420, "coord_y": 55}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_66":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"width": 5
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 530, "coord_y": 55}
                                                                                                , "entry_dicc":
                                                                ...
                                                                , "WIDGET_67":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"width": 5
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 570, "coord_y": 55}
                                                                                                , "entry_dicc":
                                                                                                            {"formato_validacion": "entero_positivo"
                                                                ...
                                                                , "WIDGET_68":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "black"
                                                                                                , "anchor": "w"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 420, "coord_y": 85}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_69":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"width": 12
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 530, "coord_y": 85}
                                                                                                , "entry_dicc":
                                                                                                            {"formato_validacion": "entero_positivo"
                                                                ...
                                                                , "WIDGET_70":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"width": 40
                                                                                                , "image": mod_gen.img_control_versiones_boton_migrar_lineas_codigo
                                                                                                , "compound": "left"
                                                                                                , "imagen_tupla_resize": (33, 23)
                                                                                                , "controltiptext": "Ejecuta migraciones de lineas de código entre los scripts de objetos de las 2 bases de datos"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 640, "coord_y": 65}
                                                                                                , "dicc_rutina":
                                                                ...
                                                                , "WIDGET_71":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                {"width": 40
                                                                                                , "image": mod_gen.img_control_versiones_boton_merge_bbdd_fisica
                                                                                                , "compound": "left"
                                                                                                , "imagen_tupla_resize": (33, 23)
                                                                                                , "controltiptext": "Permite acceder a la ventana para realizar los MERGE en base de datos fisica"
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 720, "coord_y": 65}
                                                                                                , "dicc_rutina":
                                                    ...
                                                    {"frame_inicio":
                                                                ...
                                                                , "WIDGET_74":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 400, "coord_y": 18}
                                                                                                , "dicc_rutina":
                                                                ...
                                                                , "WIDGET_75":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 500, "coord_y": 18}
                                                                                                , "dicc_rutina":
                                                                                                                {"rutina": "def_merge_bbdd_fisicas_click_boton" #la rutina tiene que estar definida en la clase gui_ventana_merge_bbdd_fisicas
                                                                                                                , "tipo_rutina": "command"
                                                                ...
                                                                , "WIDGET_77":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "fg": "white"
                                                                                                , "justify": tk.CENTER
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 218}
                                                                                                }
                                                                            }
                                                                ...
                                                                , "WIDGET_78":
                                                                            ...
                                                                            , "kwargs_config":
                                                                                                ...
                                                                                                , "bg": "#DDE1E2"
                                                                                                , "wrap": tk.NONE
                                                                                                , "colocacion_dicc": {"metodo": "place", "coord_x": 20, "coord_y": 245}
