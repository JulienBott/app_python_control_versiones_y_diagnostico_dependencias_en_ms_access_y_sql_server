...
def def_proceso_sql_server_2_control_versiones():
    ...
    try:
        ...
        del dicc_errores_temp
        del lista_dicc_errores_migracion
        raise #es pass para que se localicen todos los posibles errores en el proceso
...
def def_proceso_sql_server_2_diagnostico(opcion, servidor_selecc, lista_bbdd_selecc, ruta_destino):
    ...
    try:
        ...
        if opcion == lista_GUI_diagnostico_combobox_sql_server[0]:
            ...
            saveas = os.path.normpath(os.path.join(ruta_destino, f"DEPENDENCIAS_SQL_SERVER_{now}.xlsb"))
        ...
        ##################################################################################
            ...
            ruta_export = os.path.normpath(os.path.join(ruta_destino, now))
            os.makedirs(ruta_export, exist_ok = True)
    

            #se crean las subcarpetas por bbdd
            for bbdd in lista_bbdd_selecc:
                ruta_export_bbdd = os.path.normpath(os.path.join(ruta_export, bbdd))
                ...
                for esquema in lista_esquemas:
                    ruta_export_esquema = os.path.normpath(os.path.join(ruta_export_bbdd, esquema))
                    ...
                    for tipo_objeto in lista_tipo_objetos:
                        ruta_export_tipo_objeto = os.path.normpath(os.path.join(ruta_export_esquema, tipo_objeto))
                        ...
                        for nombre_objeto, df_codigo in lista_objetos:
                            ...
                            nombre_objeto_corr = os.path.normpath(os.path.join(ruta_export_tipo_objeto, nombre_objeto_corr))
